 ...
 * baked at camRef appears at screen + (margin, margin); the current camera
 * shifts it by −(cam−camRef)·zoom (actors-layer delta), so the draw offset is
 * that delta minus the margin. */
